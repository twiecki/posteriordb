def make_model(data: dict) -> pm.Model:
    ...
    with pm.Model() as model:
        ...
        obsyear = np.array(data['obsyear']) - 1  # Convert to 0-based indexing
        obssite = np.array(data['obssite']) - 1  # Convert to 0-based indexing
        misyear = np.array(data['misyear']) - 1  # Convert to 0-based indexing
        missite = np.array(data['missite']) - 1  # Convert to 0-based indexing
